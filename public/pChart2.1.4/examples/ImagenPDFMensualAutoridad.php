...
$conn->terminarConexion();
 ...
 $myPicture->drawText(110,150,"CI: ".$ci['CI']."                 NOMBRE:  ".$ci['NOMBRES'],$TextSettings); 
...
// $Indicator->draw(80,160,550,30,$IndicatorSettings);
 ...
 $myPicture->render("pictures/RMAut".$ci['CI'].".PNG");
 header('Location: ../../PDF/FormatoGestionCalidadReporteMensualAutoridad.php');
 //require '';
?>
