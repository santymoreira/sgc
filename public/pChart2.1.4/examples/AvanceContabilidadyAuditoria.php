...
{
    $avance1= round((($val1[0]*18)/100),2);
    
    //$avance1=round($val1[0],2);
//    $avance1=
}
...
{
    $avance7= round((($val7[0]*10)/100),2);
    //$avance7=round($val7[0],2);
}
$avance=round($avance1+$avance2+$avance3+$avance4+$avance5+$avance6+$avance7,2);
