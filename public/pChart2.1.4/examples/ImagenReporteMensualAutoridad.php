...
$conn->conectarBD();
$query3 = "CALL PorcentajeReporteMensual(".$_SESSION['promem'].",".$_SESSION['macromem'].",2,".$_SESSION['sumamensualem'].",". $_SESSION['numrowsem'].")";
...
$conn->conectarBD();
//$_SESSION['user1']
$query4="SELECT CI,NOMBRES FROM empleado WHERE COD_EMPLEADO = '".$_SESSION['user1']."'";
//$query4 = "CALL PorcentajeReporteMensual(".$_SESSION['promem'].",".$_SESSION['macromem'].",2,".$_SESSION['sumamensualem'].",". $_SESSION['numrowsem'].")";
$m4= mysql_query($query4) or die ("Por favor ingrese los datos correctamente3");
$ci= mysql_fetch_array($m4);
...
//$cumplimiento=mysql_fetch_array($cump);
 ...
 $myPicture->drawText(110,200,"CI: ".$ci['CI']."                 NOMBRE:  ".$ci['NOMBRES'],$TextSettings); 
