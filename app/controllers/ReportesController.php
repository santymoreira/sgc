...
class ReportesController extends BaseController {
      ...
      public function individual($escuela)
    {
        ...
        $tipos=DB::select('SELECT TE.COD_TIPO,TE.DESCRIPCION FROM empleado_tipo AS ET INNER JOIN empleado AS E 
         ...
         return View::make('reportes.individual', array('tipoEmpleados' => $tipos,'escuela' =>$escuela));
    }
    ...
    public function combo2()
    {
        ...
        //echo("<script>console.log('PHP: ".$macroproceso."');</script>");
    	$proceso = DB::table('proceso')->where('TIPO_EMPLEADO', '=', $tipoEmpleado)->where('COD_MACROPROCESO','=',$macroproceso)->get();
    	 return View::make('reportes.procesos', array('procesos' => $proceso,'tipoEmpleado' => $tipoEmpleado,'macroproceso' => $macroproceso,'escuela' =>$escuela));
    }
    ...
    public function combo1()
    {
        ...
        return View::make('reportes.macroprocesos', array('macroprocesos' => $macroprocesos,'tipoEmpleado' => $tipoEmpleado,'escuela' =>$escuela));
    }
    ...
    public function tabla()
    {
        ...
        return View::make('reportes.tabla', array('indicadores' => $indicadores,'escuela' =>$escuela,'macroproceso'=>$macroproceso,'proceso'=>$proceso,'codigoEmpleado'=>$codigoEmpleado));
    }

    public function imagenReporte($escuela,$macroproceso,$proceso,$f1,$f2)
    {    
