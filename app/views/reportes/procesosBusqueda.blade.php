...
var proceso=0;
    ...
    //alert(codigo);
    $('#tablares').load("../../tabla",{escuela:escuela,tipoEmpleado:tipo,macroproceso:macro,proceso:proceso,cedula:cedula,codigo:codigo,tipoReporte:tipoReporte,mes:seleccion});
});
