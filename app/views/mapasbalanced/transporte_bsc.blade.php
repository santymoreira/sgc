            ...
            <ul>
               <li class="nivel1"><a class="nivel1" href="../welcome">Inicio </a></li>
                ...
                <li class="nivel1"><a onclick="Alert()" class="nivel1">Reportes</a>
                  <ul class="cuatro">
                        <li><a {{ HTML::link('reportes/individual_bsc/6/1', 'Individual');}} </a></li>
                         <li><a {{ HTML::link('reportes/individual_bsc/6/2', 'Mensual');}} </a></li>
                          <li><a {{ HTML::link('reportes/mensualE_bsc/6/3', 'Mensual Empleados');}} </a></li>
                          <li><a {{ HTML::link('reportes/mensualE_bsc/6/4', 'Individual Empleados');}} </a></li>
...
@section('body')
        ...
        <div id="position1" class="layout-cell content">    
              <center> <label>Avance BSC</label>
                    <a rel="floatbox" class="fbPopup" title="Avance BSC Gestión de Transporte" rev="width:608 height:217 scrolling:no" href="../consolidadoEscuela_bsc/{{Session::get('escuela')}}">
                       @if($total <= 70) 
                    ...
                    <br/>
                <!-- Logo SGC escuela -->    
                  <img src="{{ asset('images/transportebsc/transporte.png') }}" width="780" height="295">
            </center>     
