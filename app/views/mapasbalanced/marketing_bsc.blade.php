         ...
         <div id="menu">
            <ul>
                ...
                <li class="nivel1"><a onclick="Alert()" class="nivel1">Reportes</a>
                  <ul class="cuatro">
                        <li><a {{ HTML::link('reportes/individual_bsc/5/1', 'Individual');}} </a></li>
                         <li><a {{ HTML::link('reportes/individual_bsc/5/2', 'Mensual');}} </a></li>
                          <li><a {{ HTML::link('reportes/mensualE_bsc/5/3', 'Mensual Empleados');}} </a></li>
                          <li><a {{ HTML::link('reportes/mensualE_bsc/5/4', 'Individual Empleados');}} </a></li>
...
@section('body')
        ...
        <div id="position1" class="layout-cell content">    
             <center> <label>Avance BSC</label>
                    <a rel="floatbox" class="fbPopup" title="Avance BSC Marketing" rev="width:608 height:217 scrolling:no" href="../consolidadoEscuela_bsc/{{Session::get('escuela')}}">
                      <input type="image" src="{{asset('images/Utilitarios/chart_bar.png'); }}"/>
                    </a>
                    <br/>
                <!-- Logo SGC escuela -->    
                  <img src="{{ asset('images/marketingbsc/marketing.png') }}" width="850" height="295">
            </center>     
