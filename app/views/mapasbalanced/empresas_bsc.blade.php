...
@section('options')
   			 ...
   			 <div id="menu">
						<ul>
							  ...
							  <li class="nivel1"><a class="nivel1" {{ HTML::link('empresas/perspectivas', 'Perspectivas');}}
...
@section('body')
        ...
        <div id="position1" class="layout-cell content">    
          <center> <label>Avance BSC</label>
                    <a rel="floatbox" class="fbPopup" title="Avance BSC Administración de Empresas" rev="width:608 height:217 scrolling:no" href="">
                      <input type="image" src="{{asset('images/Utilitarios/chart_bar.png'); }}"/>
                    </a>
                    <br/>
                <!-- Logo SGC escuela -->    
                  <img src="{{ asset('images/empresasbsc/empresas.png') }}" width="850" height="295">
            </center>     
