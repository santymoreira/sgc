...
@section('body')
        <div class="content-layout" >
          <div id="apDiv21"><center><img src="{{ asset('images/exterior/contenedor.png') }}" width="949" height="643"></center></div>
            <div class="cleared"> 
			   <div id="apDiv22">
          ...
          <div id="apDiv29"> 
				...
				<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
					  <p style="font-size:10px;color:#03F" style="position:fixed; bottom:0; left:0;" >Copyright © 2014. All Rights Reserved.</p>
				</center>
			</div>	
        </div>
@stop