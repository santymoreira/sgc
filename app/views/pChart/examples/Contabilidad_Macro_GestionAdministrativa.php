...
$conn->conectarBD();
$porcent="CALL consolidadoMacroprocesos(4)";
...
switch ($val[1]){
 ...
 $myPicture = new pImage(590,200,$MyData);// tamaño aki
 ...
 $myPicture->drawText(20,25,'Gestion Administrativa',array("R"=>255,"G"=>255,"B"=>255));
